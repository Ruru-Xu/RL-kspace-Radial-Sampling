...
from nnunet.preprocessing.preprocessing import normalize
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def preprocess_patient(self, input_files):
        ...
        #
        # d, s, properties, sampling_mask = preprocessor.preprocess_test_case(input_files,
        #                                                      self.plans['plans_per_stage'][self.stage][
        #                                                          'current_spacing'])
        d, s, sampling_mask = normalize()
        return d, s, sampling_mask
